...
class PredictionMarketSearchClient:
    ...
    async def search_prediction_markets(self, query: str, minimum_volume: Optional[float] = None, is_first_search = True):
        ...
        # Testing
        print("Adj results: ")
        print(len(self.adj_results))
        print(self.adj_results)
        print("=====================")
        print("Manifold results: ")
        print(self.manifold_results)


# TODO

# One direct search with the question, save to in-class variable
# One general search with a query generated by an llm based on context, save to in-class variable
# Aggregate ids markets and descriptions and give to llm to filter